...
namespace CodeStage.Maintainer
{
	...
	public static class Maintainer
	{
		...
		public static string Directory
		{
			get
			{
				...
				if (!string.IsNullOrEmpty(directory))
				{
					...
					{
						directory = null;
						Debug.LogError(ConstructErrorForSupport("Looks like Maintainer is placed in project incorrectly!"));
					}
				}
				else
				{
					directory = null;
					Debug.LogError(ConstructErrorForSupport("Can't locate the Maintainer directory!"));
				}
				return directory;
			}
		}
		...
		internal static string ConstructErrorForSupport(string errorText, string moduleName = null, Exception exception = null)
		{
