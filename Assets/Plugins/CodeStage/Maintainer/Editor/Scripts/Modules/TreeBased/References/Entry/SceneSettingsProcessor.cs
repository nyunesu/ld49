...
namespace CodeStage.Maintainer.References.Entry
{
	...
	internal static class SceneSettingsProcessor
	{
		...
		private static void CheckNavMesh(TreeConjunction conjunction, int candidateInstanceId)
		{
			...
			{
				Debug.LogError(
					Maintainer.ConstructErrorForSupport("Can't find m_NavMeshData at the navMeshSettingsObject!"));
			}
		}
		...
		private static void CheckLightMapSettings(TreeConjunction conjunction, int candidateInstanceId)
		{
			...
			{
				Debug.LogError(Maintainer.ConstructErrorForSupport("Can't find m_LightmapParameters at the LightmapSettings!"));
			}
		}
		...
		private static void CheckRenderSettingsTexture(TreeConjunction conjunction, int candidateInstanceId)
		{
			...
			{
				Debug.LogError(Maintainer.ConstructErrorForSupport("Can't find m_HaloTexture at the RenderSettings!"));
			}
			...
			{
				Debug.LogError(Maintainer.ConstructErrorForSupport("Can't find m_SpotCookie at the RenderSettings!"));
			}
