...
namespace CodeStage.Maintainer.Issues
{
	...
	internal static class IssuesFixer
	{
		...
		private static bool FixMissingComponents(GameObjectIssueRecord issue, GameObject go, bool alternative)
		{
			...
			if (tracker == null)
			{
				Debug.LogError(Maintainer.ConstructErrorForSupport("Can't get active tracker."));
				return false;
			}
		...
		public static FixResult FixMissingReference(Object unityObject, string propertyPath, RecordLocation location)
		{
			...
			if (sp == null)
			{
				Debug.LogWarning(Maintainer.ConstructErrorForSupport("Unexpected behavior! Couldn't find property '" + propertyPath +
			...
			else if (MissingReferenceDetector.IsPropertyHasMissingReference(sp))
			{
